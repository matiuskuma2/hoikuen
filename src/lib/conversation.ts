...
import { calculateMealFlags, type MealFlags } from './meal-rules';
export { calculateMealFlags, type MealFlags };
...
// calculateMealFlags は src/lib/meal-rules.ts に統合 (SSOT)
// 後方互換のため re-export 済み（ファイル先頭参照）
