 ...
 * あゆっこ保育園の時間帯境界値（分単位）
 * 
 * 早朝保育: 07:00-07:30 (420-450) → 早朝保育料
 * 通常保育: 07:30-20:00 (450-1200)
 * 延長保育: 20:00-21:00 (1200-1260) → 延長保育料
 * 夜間保育: 21:00以降 (1260+) → 夜間保育料 (木村さん要件: 7:00-7:30 / 20:00-21:00 が課金対象)
 * 
 * ビジネスルール:
 * - 早朝保育料: 7:00-7:30 の間の登園に適用 (¥300/回)
 * - 延長保育料: 20:00以降の降園に適用 (¥300/回)
 * - 夜間保育料: 21:00以降の降園に適用 (¥3,000/¥2,500)
 */
export const TIME_BOUNDARIES = {
  ...
  early_end: 450,
  /** 延長保育開始 20:00 = 1200分 (木村さん要件: 20:00-21:00) */
  extension_start: 1200,
  /** 夜間保育開始 21:00 = 1260分 */
  night_start: 1260,
  /** 閉園時刻 21:00 = 1260分 */
  close: 1260,
