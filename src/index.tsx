          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div>
              <label class="text-sm font-medium text-gray-700 mb-2 block">
                ...
                <span class="text-xs text-gray-400 ml-1">(複数ファイル / 写メ・PDF対応)</span>
              </label>
              <div id="drop-schedule" class="drop-zone rounded-xl p-6 text-center cursor-pointer hover:border-blue-400"
                ...
                <i class="fas fa-cloud-upload-alt text-2xl text-gray-400 mb-1"></i>
                <p class="text-sm text-gray-500">ドラッグ&ドロップ または クリック</p>
                <p class="text-xs text-gray-400 mt-1">.xlsx / .pdf / .jpg / .png</p>
                <input type="file" id="input-schedule" class="hidden" accept=".xlsx,.pdf,.jpg,.jpeg,.png,.heic" multiple onchange="handleFileSelect(event, 'schedule')">
              </div>
